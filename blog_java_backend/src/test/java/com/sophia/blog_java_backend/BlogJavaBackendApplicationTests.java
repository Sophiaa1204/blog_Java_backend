...
class BlogJavaBackendApplicationTests implements ApplicationContextAware {
	// ApplicationContext就是Spring容器，是一个接口
	...
	public void testApplicationContext() {
		...
		alphaDao = applicationContext.getBean("alphaHiberante", AlphaDao.class);
		System.out.println(alphaDao.select());
	}
